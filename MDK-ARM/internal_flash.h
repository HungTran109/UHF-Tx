...
//#define	BOOTLOADER_MAX_SIZE 0x1000 /* 1K */
...
#define	CONFIG_ADDR	(0x08080000U)		/* Page 127 */

#define	CONFIG_FLAG_ADDR	CONFIG_ADDR
#define	CONFIG_FLAG_LENGTH	4

#define CONFIG_FREQ_PAIR        (uint32_t)(CONFIG_FLAG_ADDR + CONFIG_FLAG_LENGTH)
#define CONFIG_FREQ_PAIR_LENGHT        4
...
//#define	CONFIG_FRE_RUN_ADDR		(uint32_t)(CONFIG_LOCAL_MODE_ADDR + CONFIG_LOCAL_MODE_LENGTH)
//#define	CONFIG_FRE_RUN_LENGTH	4
